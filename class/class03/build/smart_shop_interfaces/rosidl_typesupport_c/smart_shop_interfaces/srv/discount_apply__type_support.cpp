...
static const _DiscountApply_Request_type_support_symbol_names_t _DiscountApply_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smart_shop_interfaces, srv, DiscountApply_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, smart_shop_interfaces, srv, DiscountApply_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, smart_shop_interfaces, srv, DiscountApply_Request)() {
  return &::smart_shop_interfaces::srv::rosidl_typesupport_c::DiscountApply_Request_message_type_support_handle;
}
...
static const _DiscountApply_Response_type_support_symbol_names_t _DiscountApply_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smart_shop_interfaces, srv, DiscountApply_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, smart_shop_interfaces, srv, DiscountApply_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, smart_shop_interfaces, srv, DiscountApply_Response)() {
  return &::smart_shop_interfaces::srv::rosidl_typesupport_c::DiscountApply_Response_message_type_support_handle;
}
...
static const _DiscountApply_type_support_symbol_names_t _DiscountApply_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smart_shop_interfaces, srv, DiscountApply)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, smart_shop_interfaces, srv, DiscountApply)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, smart_shop_interfaces, srv, DiscountApply)() {
  return &::smart_shop_interfaces::srv::rosidl_typesupport_c::DiscountApply_service_type_support_handle;
}
