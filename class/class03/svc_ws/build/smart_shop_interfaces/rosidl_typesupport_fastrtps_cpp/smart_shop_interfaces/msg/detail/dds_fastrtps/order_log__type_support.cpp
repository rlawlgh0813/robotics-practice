...
#include "smart_shop_interfaces/msg/detail/order_log__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smart_shop_interfaces::msg::OrderLog;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smart_shop_interfaces::msg::OrderLog *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smart_shop_interfaces::msg::OrderLog *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _OrderLog__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const smart_shop_interfaces::msg::OrderLog *>(
...
static size_t _OrderLog__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_OrderLog(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _OrderLog__callbacks = {
...
static rosidl_message_type_support_t _OrderLog__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_OrderLog__callbacks,
...
{
  return &smart_shop_interfaces::msg::typesupport_fastrtps_cpp::_OrderLog__handle;
}
