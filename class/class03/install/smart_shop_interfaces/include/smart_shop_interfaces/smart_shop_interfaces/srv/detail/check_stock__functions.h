...
#ifndef SMART_SHOP_INTERFACES__SRV__DETAIL__CHECK_STOCK__FUNCTIONS_H_
#define SMART_SHOP_INTERFACES__SRV__DETAIL__CHECK_STOCK__FUNCTIONS_H_
 ...
 * calls
 * smart_shop_interfaces__srv__CheckStock_Request__init().
...
/**
 * It calls
 * smart_shop_interfaces__srv__CheckStock_Request__fini()
 ...
 * smart_shop_interfaces__srv__CheckStock_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * smart_shop_interfaces__srv__CheckStock_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * smart_shop_interfaces__srv__CheckStock_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_smart_shop_interfaces
...
/**
 * It calls
 * smart_shop_interfaces__srv__CheckStock_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_smart_shop_interfaces
...
/**
 * It allocates the memory for the array and calls
 * smart_shop_interfaces__srv__CheckStock_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_smart_shop_interfaces
...
/**
 * It calls
 * smart_shop_interfaces__srv__CheckStock_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SMART_SHOP_INTERFACES__SRV__DETAIL__CHECK_STOCK__FUNCTIONS_H_
