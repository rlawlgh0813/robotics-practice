...
#ifndef SMART_SHOP_INTERFACES__SRV__DETAIL__PLACE_ORDER__FUNCTIONS_H_
#define SMART_SHOP_INTERFACES__SRV__DETAIL__PLACE_ORDER__FUNCTIONS_H_
...
/// Initialize srv/PlaceOrder message.
/**
...
/// Finalize srv/PlaceOrder message.
/**
...
/// Create srv/PlaceOrder message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * smart_shop_interfaces__srv__PlaceOrder_Request__init().
...
/// Destroy srv/PlaceOrder message.
/**
 * It calls
 * smart_shop_interfaces__srv__PlaceOrder_Request__fini()
...
/// Check for srv/PlaceOrder message equality.
/**
...
/// Initialize array of srv/PlaceOrder messages.
/**
...
/// Finalize array of srv/PlaceOrder messages.
/**
 * It calls
 * smart_shop_interfaces__srv__PlaceOrder_Request__fini()
...
/// Create array of srv/PlaceOrder messages.
/**
 * It allocates the memory for the array and calls
 * smart_shop_interfaces__srv__PlaceOrder_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PlaceOrder messages.
/**
 * It calls
 * smart_shop_interfaces__srv__PlaceOrder_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PlaceOrder message array equality.
/**
...
/// Copy an array of srv/PlaceOrder messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * smart_shop_interfaces__srv__PlaceOrder_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_smart_shop_interfaces
...
/**
 * It calls
 * smart_shop_interfaces__srv__PlaceOrder_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_smart_shop_interfaces
...
/**
 * It allocates the memory for the array and calls
 * smart_shop_interfaces__srv__PlaceOrder_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_smart_shop_interfaces
...
/**
 * It calls
 * smart_shop_interfaces__srv__PlaceOrder_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SMART_SHOP_INTERFACES__SRV__DETAIL__PLACE_ORDER__FUNCTIONS_H_
