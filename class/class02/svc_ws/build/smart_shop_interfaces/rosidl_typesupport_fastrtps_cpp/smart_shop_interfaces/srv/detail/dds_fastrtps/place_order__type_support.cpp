...
#include "smart_shop_interfaces/srv/detail/place_order__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smart_shop_interfaces::srv::PlaceOrder_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smart_shop_interfaces::srv::PlaceOrder_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smart_shop_interfaces::srv::PlaceOrder_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PlaceOrder_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const smart_shop_interfaces::srv::PlaceOrder_Request *>(
...
static size_t _PlaceOrder_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PlaceOrder_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PlaceOrder_Request__callbacks = {
...
static rosidl_message_type_support_t _PlaceOrder_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PlaceOrder_Request__callbacks,
...
{
  return &smart_shop_interfaces::srv::typesupport_fastrtps_cpp::_PlaceOrder_Request__handle;
}
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.payment_auth_code;
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = smart_shop_interfaces::srv::PlaceOrder_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smart_shop_interfaces::srv::PlaceOrder_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<smart_shop_interfaces::srv::PlaceOrder_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PlaceOrder_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const smart_shop_interfaces::srv::PlaceOrder_Response *>(
...
static size_t _PlaceOrder_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PlaceOrder_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PlaceOrder_Response__callbacks = {
  "smart_shop_interfaces::srv",
  "PlaceOrder_Response",
...
static rosidl_message_type_support_t _PlaceOrder_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PlaceOrder_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &smart_shop_interfaces::srv::typesupport_fastrtps_cpp::_PlaceOrder_Response__handle;
}
...
static service_type_support_callbacks_t _PlaceOrder__callbacks = {
  "smart_shop_interfaces::srv",
  "PlaceOrder",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smart_shop_interfaces, srv, PlaceOrder_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smart_shop_interfaces, srv, PlaceOrder_Response)(),
...
static rosidl_service_type_support_t _PlaceOrder__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PlaceOrder__callbacks,
...
{
  return &smart_shop_interfaces::srv::typesupport_fastrtps_cpp::_PlaceOrder__handle;
}
